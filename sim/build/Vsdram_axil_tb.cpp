...
void Vsdram_axil_tb___024root__trace_decl_types(VerilatedFst* tracep);

void Vsdram_axil_tb___024root__trace_init_top(Vsdram_axil_tb___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vsdram_axil_tb::trace(VerilatedFstC* tfp, int levels, int options) {
    if (tfp->isOpen()) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vsdram_axil_tb::trace()' shall not be called after 'VerilatedFstC::open()'.");
    }
