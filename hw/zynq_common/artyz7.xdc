...
# CPU divided clock: 50 MHz / 24 = ~2.083 MHz
# Generated by a BUFGCE inside portb_tester/u_clk_div.
# Vivado treats this as a proper clock domain derived from clk50MHz.
create_generated_clock -name clk_cpu \
    -source [get_pins u_zynq/processing_system7_0/inst/FCLK_CLK1] \
    -divide_by 24 \
    [get_pins {u_portb_tester/u_clk_div/BUFGCE_cpu/O}]
