...
VL_ATTR_COLD void Vsdram_axil_tb___024root___eval_initial__TOP(Vsdram_axil_tb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsdram_axil_tb___024root___eval_initial__TOP\n"); );
    // Init
    ...
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__Dq_reg = 0U;
    ...
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__WR_chk[0U] = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__WR_chk[1U] = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__WR_chk[2U] = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__WR_chk[3U] = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__WR_counter[0U] = 0U;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__WR_counter[1U] = 0U;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__WR_counter[2U] = 0U;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__WR_counter[3U] = 0U;
    ...
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RC_chk = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RRD_chk = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RAS_chk0 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RAS_chk1 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RAS_chk2 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RAS_chk3 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RCD_chk0 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RCD_chk1 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RCD_chk2 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RCD_chk3 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RP_chk0 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RP_chk1 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RP_chk2 = 0ULL;
    vlSelf->sdram_axil_tb__DOT__u_sdram_model__DOT__RP_chk3 = 0ULL;
    VL_TIMEFORMAT_IINI(0xfffffff7U, 0U, std::string{" ns"}, 0xcU, vlSymsp->_vm_contextp__);
    vlSymsp->TOP__sdram_axil_tb__DOT__sdram_dev_if.write_data = 0U;
...
VL_ATTR_COLD void Vsdram_axil_tb___024root___eval_triggers__stl(Vsdram_axil_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsdram_axil_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsdram_axil_tb___024root___eval_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void Vsdram_axil_tb___024root___stl_sequent__TOP__0(Vsdram_axil_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsdram_axil_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsdram_axil_tb___024root___stl_sequent__TOP__0\n"); );
    // Body
    ...
    vlSymsp->TOP__sdram_axil_tb__DOT__sdram_dev_if.dqm 
        = ((IData)(vlSelf->sdram_axil_tb__DOT__u_sdram_controller__DOT__rw)
            ? 0U : (3U & (IData)(vlSelf->sdram_axil_tb__DOT__u_sdram_controller__DOT__dqm_reg)));
    ...
    if (vlSymsp->TOP__sdram_axil_tb__DOT__axi_if.arvalid) {
        vlSymsp->TOP__sdram_axil_tb__DOT__axi_if.arready 
            = vlSelf->sdram_axil_tb__DOT__u_sdram_controller__DOT__rdy;
        ...
        vlSymsp->TOP__sdram_axil_tb__DOT__axi_if.arready = 0U;
        vlSymsp->TOP__sdram_axil_tb__DOT__sdram_ctrl_if.write_data = 0U;
        vlSymsp->TOP__sdram_axil_tb__DOT__sdram_ctrl_if.addr = 0U;
    }
